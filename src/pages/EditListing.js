				...
				<form onSubmit={onSubmit} className='w-full max-w-xl my-8'>
					<div className='flex flex-wrap mx-3 mb-6'>
						<div className='w-full md:w-1/2 px-3 mb-6 md:mb-0'>
							...
							<textarea
								className='w-auto bg-white text-accent py-3.5 px-12 font-semibold rounded-2xl text-base mt-2 mr-2 md:mb-0 ml-0 flex justify-center items-center border border-base-100 outline-none md:w-full py-3.5 px-3.5'
								type='text'
								id='address'
								value={address}
								onChange={onMutate}
